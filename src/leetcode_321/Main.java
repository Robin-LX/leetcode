...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println(solution.getMaxValue(new int[]{8, 5}, new int[]{8, 7, 8}));
    }
}
            ...
            if (arr1[arr1Idx] == arr2[arr2Idx]) {
                ...
                if (tmpArr2Idx == arr2.length || tmpArr1Idx == arr1.length) {
                    ...
                    if (tmpArr1Idx < arr1.length) {
                        //if (arr1[tmpArr1Idx] > arr1[arr1Idx]) {
                        resArr[i] = arr1[arr1Idx];
                        arr1Idx++;
                        continue;
                        //}
                    ...
                    //arr2并未越界
                    if (tmpArr2Idx < arr2.length && tmpArr1Idx == arr1.length) {
                        //if (arr2[tmpArr2Idx] > arr2[arr2Idx]) {
                        resArr[i] = arr2[arr2Idx];
                        arr2Idx++;
                        continue;
                        //}
                    }
                    //当出现接下来的数组全部一样的情况下，随便取一个
                    resArr[i] = arr1[arr1Idx];
                    arr1Idx++;
                    continue;
                }
                ...
                //或者相等的部分有小于第一个相等值得，随便取一个
                resArr[i] = arr1[arr1Idx];
                arr1Idx++;
                continue;
            }
            //指向不同的值
            if (arr1[tmpArr1Idx] > arr2[tmpArr2Idx]) {
                resArr[i] = arr1[arr1Idx];
                arr1Idx++;
            }
            if (arr1[tmpArr1Idx] < arr2[tmpArr2Idx]) {
